...
- 本机当前通过112项自动测试；DGX上一批106项基线已通过，新增操作者审核台与Evidence安全定位正在本批复验。17项路演成果、高推理语义复核、选择性重建边界、离线包发布前Schema门禁、成片SHA-256、视频证据包、连续动作候选窗口、PDF结构报告、路演PPT、运行时基准、用户服务和Web白名单保持原验证边界。
