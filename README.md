...
- 本机当前通过122项自动测试；DGX上一批112项基线已通过，本批传输容错、可恢复工作流检查点与离线包跨文件绑定正在远端复验。17项路演成果、操作者审核台、Evidence安全定位、高推理语义复核、选择性重建边界、成片SHA-256、视频证据包、连续动作候选窗口、PDF结构报告、路演PPT、运行时基准、用户服务和Web白名单保持原验证边界。
